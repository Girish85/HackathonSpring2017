...
public class signup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SSo = (EditText)findViewById(R.id.editText44);
        //code = (EditText)findViewById(R.id.editText5);
        pwd = (EditText)findViewById(R.id.editText46);
    ...
    void onPassword(View view){
        ...
        mauth.createUserWithEmailAndPassword(emailid,pawd).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                String keyer = emailid.replace(".","@");
                reference.child(keyer).setValue(" ");
        ...
        if (user != null) {
            user.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    else Toast.makeText(getApplicationContext(),"couldn't send email verification",Toast.LENGTH_LONG).show();
                }
            });
        }
        Intent i = new Intent(signup.this,index.class);
        startActivity(i);
    }
}
